...
const { productString, productPriceString, orderDetailString, reportDetailString } = require("../constants/entityName.js")
...
const productEntity = new EntitySchema({
  ...
  relations: {
    ...
    product_reportDetail_relation: {
      type: 'one-to-many',
      target: reportDetailString,
      inverseSide: 'reportDetail_product_relation',
    },
  }
})
